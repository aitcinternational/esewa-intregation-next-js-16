                    ...
                    <div className="pt-2">
                        ...
                        <div className="mt-8 flex gap-4">
                            ...
                            <Link
                                ...
                                className="flex-1 bg-orange-500 text-white py-4 rounded-full font-bold text-lg shadow-lg hover:bg-orange-600 transition transform active:scale-95 flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="text-gray-600 leading-relaxed text-base min-h-[200px]">
                                ...
                                {activeAccordion === 'about-store' && (
                                    <div>
                                        <p>eSewa Integration Demo is dedicated to bringing you the finest furniture and home decor from around the world. We believe in quality, sustainability, and exceptional customer service.</p>
                                    </div>
                                )}
